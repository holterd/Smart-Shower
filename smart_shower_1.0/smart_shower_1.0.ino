...
byte prevState_RFID = LOW;                              // RFID funn/ikke
byte RFID_on = LOW;
byte prev_on = LOW;
byte on = LOW;
...
void loop() {
  ...
  // Sjekker om det er kjent RFID kort
  ...
  while (off) {
    ...
    */
      ...
      // Skal komme hit ved redigering, her skal en kunne styre motorer og lagre ved trykk
        Serial.println("Press button to add user");
